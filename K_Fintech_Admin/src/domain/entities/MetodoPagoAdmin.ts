export class MetodoPagoEntity {
  ...
  constructor(
    ...
    maximoCuotas: number,
    integracionPasarela: boolean,
    habilitadoPorTienda: boolean = true,
    configuracionTiendas: any[] = [],
    fechaCreacion: Date,
    fechaModificacion: Date
  ) {
    ...
    this.habilitadoPorTienda = habilitadoPorTienda;
    this.configuracionTiendas = configuracionTiendas;
...
export type MetodoPagoAdmin = MetodoPagoEntity;

export interface MetodoPagoAdminCreate {
  nombre: string;
  descripcion?: string;
  codigoInterno?: string;
  codigoSRI?: string;
...
export type MetodoPagoAdminUpdate = Partial<MetodoPagoAdminCreate>;